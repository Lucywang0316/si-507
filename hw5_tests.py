...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        deck = HW_cards.Deck() 
        card = deck.deal_card() 
        self.assertIsInstance(card, HW_cards.Card)
        return card, HW_cards.Card
    ...
    def test_q6(self):
        ...
        deck.deal_card() 
        new_size = len(deck.cards)
        self.assertEqual(new_size, initial_size - 1)
        return new_size, initial_size - 1
    ...
    def test_q8(self):
        ...
        new_size = len(deck.cards)
        self.assertEqual(new_size, initial_size)
